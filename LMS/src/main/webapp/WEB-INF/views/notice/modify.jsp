...
<body>
		...
		<div class="card shadow mb-4">
			<div class="card-header py-3">
				<h6 class="m-0 font-weight-bold text-primary" style="font-size: 20px; font-weight: 800;">공지사항 수정</h6>
			</div>
			<div class="card-body">
	...
	<div class='btn_blue' style='padding: 2rem; text-align: center;'>
		...
		<a class='btn btn-danger btn-icon-split' href="list.no" style="font-size: 18px; font-weight: 600; ">취소</a>
	</div>
